...
int data_valid_http_protocol(HTTP_SESSION *http_session)
{
	...
	} /* Sprawdzenie, czy protokï¿½ jest obsï¿½ugiwany */
...
+ po pomyï¿½lnej weryfikacji struktury przekazuje dane do wykonania przez funkcjï¿½ http_process_session */
void data_prepare_http_session(HTTP_SESSION *http_session)
{
	...
	{	/* Brak nagï¿½ï¿½wka "Content-Length", a ï¿½ï¿½dana metoda to POST = bï¿½ï¿½d 411 */
